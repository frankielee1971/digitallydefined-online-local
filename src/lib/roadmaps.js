const ROADMAPS = {
  creator: {
    ...
    overview:
      'You think in content, story, and audience experience. This roadmap turns that instinct into a private, repeatable asset system.',
    strengths: [
  ...
  builder: {
    ...
    overview:
      'You care about infrastructure, templates, and repeatable systems. This roadmap gives you a build order for a simple, profitable digital asset.',
    strengths: [
  ...
  educator: {
    ...
    overview:
      'You learn deeply and want to translate that into trust. This roadmap helps you package one proven system into a simple, scalable offer.',
    strengths: [
      'Organizes confusing topics into clear, proven paths',
      'Builds trust through documentation and proof',
      'Creates assets that teach while they sell',
    ],
    challenges: [
      'May spend too long researching before launching',
      'Can over-explain and lose the buyer',
      'Sometimes under-values the depth of what they already know',
    ],
    recommendedNiches: [
      'Professional transitions: career change, portfolio building, certification paths',
      'Skill-based teaching for non-creative professionals',
      'Compliance or process-heavy areas where clarity is scarce',
    ],
    firstSteps: [
      'Document one micro-system you already use and turn it into a checklist',
      'Run the Niche Profitability Scorecard to confirm demand for that topic',
      'Shape the checklist into a PDF or Notion template for sale or lead magnet',
    ],
    toolsToUse: [
      'Digital Superpower Quiz — completed',
      'Niche Profitability Scorecard — validate topic demand',
      '10x ROI Calculator — model the workbook or template as an asset',
    ],
    cta: {
  ...
  connector: {
    ...
    overview:
      'You see relationships, partnerships, and group dynamics. This roadmap turns that skill into a community-backed digital asset or referral system.',
    strengths: [
      'Matches people, offers, and opportunities for shared wins',
  ...
  strategist: {
    ...
    overview:
      'You prioritize outcomes over activity. This roadmap gives you a prioritized build sequence so you do not waste effort on the wrong model.',
    strengths: [
