    ...
    <>
          ...
          <div style={{ display: 'grid', gap: '1.5rem' }}>
            {steps.map(s => (
              <div key={s.num} className="card" style={{ padding: '2rem', display: 'flex', gap: '2rem', alignItems: 'flex-start', border: '2px solid var(--black)', position: 'relative' }}>
                <div style={{ flexShrink: 0, width: '4rem', height: '4rem', background: 'var(--color-accent)', color: 'var(--white)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter', sans-serif", fontWeight: 900, fontSize: '1.5rem', border: '2px solid var(--black)' }}>{s.num}</div>
      ...
      <section className="section section--dark">
        <div className="container container--narrow" style={{ textAlign: 'center' }}>
          <h2 style={{ color: 'var(--color-surface)' }}>What We're Building</h2>
