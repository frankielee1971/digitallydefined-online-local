    ...
    <>
      <section className="page-hero">
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div className="action-row"><a href="/tools" className="btn btn--primary">Explore the Free Tools â†’</a></div>
        </div>
      </section>
      ...
      <section className="section" style={{ minHeight: '60vh', display: 'flex', alignItems: 'center' }}>
        <div className="container container--narrow" style={{ textAlign: 'center', padding: '3rem 0' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'var(--color-text-muted)', maxWidth: 600, margin: '0 auto 2rem', lineHeight: 1.7 }}>
            Start free with the tools that map your path â€” then get notified when the paid systems launch.
          </p>
          <div className="grid-3" style={{ marginBottom: '2rem', textAlign: 'left' }}>
            <div className="card" style={{ padding: '1.5rem' }}>
              ...
              <a href="/quiz" onClick={() => trackProductInterest(PRODUCT_INTERESTS[0], { source: '/products' })} className="btn btn--secondary" style={{ width: 'fit-content', fontSize: '0.75rem', padding: '0.5rem 1rem' }}>Take the Quiz â†’</a>
            </div>
            <div className="card" style={{ padding: '1.5rem' }}>
              ...
              <a href="/tools/scorecard" onClick={() => trackProductInterest(PRODUCT_INTERESTS[1], { source: '/products' })} className="btn btn--secondary" style={{ width: 'fit-content', fontSize: '0.75rem', padding: '0.5rem 1rem' }}>Score a Niche â†’</a>
            </div>
            <div className="card" style={{ padding: '1.5rem' }}>
              ...
              <a href="/tools/calculator" onClick={() => trackProductInterest(PRODUCT_INTERESTS[2], { source: '/products' })} className="btn btn--secondary" style={{ width: 'fit-content', fontSize: '0.75rem', padding: '0.5rem 1rem' }}>Model My Numbers â†’</a>
            </div>
          </div>
          <a href="/contact" className="btn btn--primary">Get Notified When Paid Systems Launch â†’</a>
